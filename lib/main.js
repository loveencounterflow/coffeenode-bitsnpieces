...
(function() {
  var LODASH, njs_fs, njs_path, permute, validate_isa_number,
    __slice = [].slice;
  ...
  this.source_line_from_locator = function(locator, context_delta) {
    var line_idx, line_nr_txt, match, route, route_with_name, source_lines, _;
    if (context_delta == null) {
      context_delta = 0;
    }
    ...
    _ = match[0], route_with_name = match[1], line_nr_txt = match[2], _ = match[3];
    ...
    return source_lines.slice(line_idx - context_delta, +(line_idx + context_delta) + 1 || 9e9);
  };
